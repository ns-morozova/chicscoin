...
const HeroSection: React.FC = () => {
    ...
    return (
        <section className="relative w-full">
            ...
            <div
                className="relative w-full h-80 bg-bottom-right mb-6 sm:bg-center sm:pt-24 sm:h-[450px] md:h-[650px] md:pt-28 lg:h-[750px] lg:pt-32 xl:h-[850px] 2xl:h-[1000px]"
                style={{
            ...
            >
                ...
                <div className="relative flex flex-col sm:items-center gap-5 px-4 md:gap-7 lg:px-8 z-20">
                    ...
                    <div className="w-full flex flex-col gap-2 sm:items-center sm:gap-3 md:gap-0">
                        ...
                        <p className="text-white sm:text-center text-sm w-1/2 sm:w-1/3 md:w-1/4 md:text-base lg:text-lg">
                            {t('hero.description')}
                        </p>
                    </div>
